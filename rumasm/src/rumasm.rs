...
pub fn mult(ra: Umword, rb: Umword, rc: Umword) -> Umword {
...
pub fn map(rb: Umword, rc: Umword) -> Umword {
    let ra: Umword = 0;
    8_u32 << OP | regs(ra, rb, rc)
}

pub fn unmap(rc: Umword) -> Umword {
    let ra: Umword = 0;
    let rb: Umword = 0;
    9_u32 << OP | regs(ra, rb, rc)
}

pub fn output(rc: Umword) -> Umword {
    let ra: Umword = 0;
    let rb: Umword = 0;
    10_u32 << OP | regs(ra, rb, rc)
}

pub fn input(rc: Umword) -> Umword {
    let ra: Umword = 0;
    let rb: Umword = 0;
    11_u32 << OP | regs(ra, rb, rc)
}

pub fn loadp(rb: Umword, rc: Umword) -> Umword {
    let ra: Umword = 0;
    12_u32 << OP | regs(ra, rb, rc)
}

pub fn loadv(rl: Umword, val: Umword) -> Umword {
    13_u32 << OP | rl << RL | val
}
